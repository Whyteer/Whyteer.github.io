...
$sql2 = "SELECT mecze.ID, mecze.Gospodarze, mecze.Goscie, mecze.Stadion, mecze.Data_i_godzina, mecze.Wynik, mecze.zdj_sklady FROM mecze JOIN druzyny ON mecze.Gospodarze = druzyny.Nazwa WHERE mecze.status = 1 AND (mecze.Gospodarze = ($sql) OR mecze.Goscie = ($sql)) ORDER BY mecze.ID ASC;";
...
<p class="h1 text-white">Ostatnie Mecze: <span style="text-decoration:underline"><?php echo $row[0]?> </span> </p>
